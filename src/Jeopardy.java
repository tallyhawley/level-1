...
public class Jeopardy implements ActionListener {
	...
	private JButton thirdButton, fourthButton, lastButton;
	Clip clip;
	...
	private void start() {
		...
		frame.setTitle("jeopardy suckers");
		// 3. Create a JPanel variable to hold the header using the createHeader method
		JPanel header = createHeader("name that musical! :^)");
	...
	// 7. Add the firstButton to the quizPanel
		...
		lastButton = createButton("$1000");
		// 10. Add the secondButton to the quizPanel
		quizPanel.add(secondButton);
		quizPanel.add(thirdButton);
		quizPanel.add(fourthButton);
		quizPanel.add(lastButton);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed==firstButton){
			...
			askQuestion("This musical about a red-headed orphan girl featured the songs 'It's A Hard Knock Life' and 'Tomorrow'","What is Annie?",200);
			// Fill in the askQuestion() method. When you play the game, the score should change.
		}
		// Or if the buttonPressed was the secondButton
		else if(buttonPressed==secondButton){
			askQuestion("This musical made its Broadway debut in 2008 in the Richard Rodgers theater.","What is In The Heights?",400);
		}
		else if(buttonPressed==thirdButton){
			askQuestion("This musical was revived on Broadway in 1998, starring Alan Cummings.","What is Cabaret?",600);
		}
		else if(buttonPressed==fourthButton){
			askQuestion("This musical made its debut in 2015 in the Deaf West Theatre, performing Steven Sater and Duncan Sheik's musical in both ASL and English.","What is Deaf West's Spring Awakening?",800);
		}
		else if(buttonPressed==lastButton){
			askQuestion("This electropop musical debuted in 2012, starring Hamilton star Philippa Soo.","What is Natasha, Pierre & The Great Comet of 1812?",1000);
		}
